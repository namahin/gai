...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        buildNavigation: function () {
            ...
            if (t) {
                var n = '<ul class="pagination pull-right" style="margin: 0px;">' + '<li><a href="#" class="prev"><i class="zmdi zmdi-chevron-up"></i></a></li>' + '<li><a href="#" class="next"><i class="zmdi zmdi-chevron-down"></i></a></li>' + '</ul>';
